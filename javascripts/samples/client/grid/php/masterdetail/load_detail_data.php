...
*/
	...
	if (isset($_GET['CustomerID'])) {
		$whereClause=" WHERE CustomerID LIKE '".$_GET["CustomerID"]."' ";
	}
	...
	$myQuery = "SELECT * FROM tblorders ".$whereClause." ORDER BY " . $sortColumn . " " . $sortDirection ." LIMIT ". $ordinalStart .",". ($pageSize) .";";
