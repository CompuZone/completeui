...
<CFOUTPUT>
	...
	#EBAGetHandler_DefineField("ProductLink")#
	#EBAGetHandler_DefineField("LastUpdated")#
	#EBAGetHandler_DefineField("ProductIcon")#
	#EBAGetHandler_DefineField("BulkAction")#
	#EBAGetHandler_DefineField("ProductPassword")#
	#EBAGetHandler_DefineField("ButtonText")#
</CFOUTPUT>
...
<cfoutput query="CustomerQuery">
	...
	<cfif CurrentRecord GREATER THAN StartRecordIndex >
		#EBAGetHandler_CreateNewRecord(ProductID)#
			...
			#EBAGetHandler_DefineRecordFieldValue("ButtonText", "ButtonText")#
			...
			#EBAGetHandler_DefineRecordFieldValue("ProductPrice", ProductPrice)#
			#EBAGetHandler_DefineRecordFieldValue("ProductQuantityPerUnit", ProductQuantityPerUnit)#
			#EBAGetHandler_DefineRecordFieldValue("LastUpdated", "2006-10-12 18:41:17")#
