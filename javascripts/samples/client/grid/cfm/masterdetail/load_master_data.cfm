...
<cfquery name="CustomerQuery" datasource="NitobiTestDB">
      ...
      SELECT TOP #TotalRecordsToRetrieve# * FROM tblMDcustomers ORDER BY #SortColumn# #SortDirection#
...
<cfoutput query="CustomerQuery">
	...
	<cfif CurrentRecord GREATER THAN StartRecordIndex >
		#EBAGetHandler_CreateNewRecord(CustomerID)#
			#EBAGetHandler_DefineRecordFieldValue("CustomerName", CustomerName)#
			...
			#EBAGetHandler_DefineRecordFieldValue("ContactTitle", ContactTitle)#
			#EBAGetHandler_DefineRecordFieldValue("PhoneNumber", PhoneNumber)#
			#EBAGetHandler_DefineRecordFieldValue("Address", Address)#
			#EBAGetHandler_DefineRecordFieldValue("Country", Country)#
			#EBAGetHandler_DefineRecordFieldValue("CustomerID", CustomerID)#
