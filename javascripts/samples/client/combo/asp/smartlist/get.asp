...
accessdb = Server.mappath(".") & "..\..\..\..\..\server\common\datasources\en\econtactsdb.mdb"
...
NewQuery = "SELECT TOP " & PageSize & " * FROM tblContacts WHERE ContactInfo LIKE '%" & SearchSubstring & "%' ORDER BY TimesEmailed DESC"
...
EBAGetHandler_DefineField("ContactInfo")
...
Do While (Not RecordSet.eof)
	...
	EBAGetHandler_DefineRecordFieldValue "ContactInfo", RecordSet("ContactInfo")
