...
' Get the table we want to query.
table = Request.QueryString("table")

' Change our where clause depending on which combo is requesting data.
...
accessdb = Server.mappath(".") & "..\..\..\..\..\server\common\datasources\en\countryProvince.mdb"
...
NewQuery = "SELECT * FROM " & table & " WHERE Info > '" & LastString & "' " & whereClause
...
Do While (Not RecordSet.eof)
	...
	MyID = RecordSet("CountryId")

	EBAGetHandler_CreateNewRecord(MyID)
	EBAGetHandler_DefineRecordFieldValue "CountryId", MyID
	EBAGetHandler_DefineRecordFieldValue "Info", RecordSet("Info")
