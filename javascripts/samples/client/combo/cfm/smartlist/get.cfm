...
<cfquery name="CustomerQuery" datasource="NitobiTestDB">
      ...
      SELECT TOP #PageSize# * FROM tblContacts WHERE ContactInfo LIKE '%#SearchSubstring#%'  ORDER BY TimesEmailed DESC
...
<cfoutput query="CustomerQuery">
		...
		#EBAGetHandler_CreateNewRecord(ContactID)#
			#EBAGetHandler_DefineRecordFieldValue("ContactInfo", ContactInfo)#
