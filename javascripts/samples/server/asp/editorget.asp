...
<%
	...
	EBAGetHandler_DefineField("ProductLink") ' hyperlink url
	EBAGetHandler_DefineField("LastUpdated") ' a date field
	EBAGetHandler_DefineField("ProductIcon") ' the image for the icon on each row
	EBAGetHandler_DefineField("BulkAction") ' for the checkbox
	EBAGetHandler_DefineField("ProductPassword") ' for the password field
	EBAGetHandler_DefineField("ButtonText")	' The label on each button	
	...
	if MaxRecords > StartRecordIndex then
		do while not RecordSet.eof
			...
			EBAGetHandler_CreateNewRecord(RecordSet("ProductID"))
				EBAGetHandler_DefineRecordFieldValue "ProductIcon", "docicon.gif"
				EBAGetHandler_DefineRecordFieldValue "ButtonText", "I'm a button"			
				EBAGetHandler_DefineRecordFieldValue "ProductPassword", "opensesame"			
				EBAGetHandler_DefineRecordFieldValue "ProductLink", "http://www.chemicalproductstuff.com"			
				EBAGetHandler_DefineRecordFieldValue "BulkAction", "no"
				...
				EBAGetHandler_DefineRecordFieldValue "LastUpdated", EBAGetHandler_ConvertDate(now()) ' Just a random date value for demonstration purposes
