<%@ Page language="c#" Codebehind="index.aspx.cs" AutoEventWireup="false" Inherits="GridCSharpSamples.Basic.ShowAll.index" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<!--_NRS_--> <!-- #Include File="..\..\..\..\..\Test\DotNet\Tests\TestLib\TestLib.inc" -->  <!--_NRE_-->
					...
					<ntb:grid id="ShowAllGrid" runat="server" Mode="NonPaging" Width="630px" Height="210px" RowInsertEnabled="False"
						...
						<ntb:columns xmlns:ntb="http://www.nitobi.com">
							<ntb:textcolumn editable="True" sortdirection="asc" visible="True" width="200" label="Contact Name"
								xdatafld="ContactName" sortenabled="true"></ntb:textcolumn>
							<ntb:textcolumn editable="True" sortdirection="asc" visible="True" width="200" sortenabled="true"
