...
<%@ Page language="c#" Inherits="GridCSharpSamples.Basic.LocalData.index" CodeFile="index.aspx.cs" %>
	...
	<body>
		<!--_NRS_--> <!-- #Include File="..\..\..\..\..\Test\DotNet\Tests\TestLib\TestLib.inc" -->  <!--_NRE_-->
					...
					<ntb:grid id="LocalDataGrid" runat="server" width="630" height="407" mode="LocalLiveScrolling"
						rowhighlightenabled="true" toolbarenabled="true" AutoKeyEnabled="True" rowsperpage="42"
