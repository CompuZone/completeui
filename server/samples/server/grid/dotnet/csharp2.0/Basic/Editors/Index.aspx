<%@ Page language="c#" Inherits="GridCSharpSamples.Basic.Editors.index" CodeFile="index.aspx.cs" %>
	...
	<body>
		<!--_NRS_--> <!-- #Include File="..\..\..\..\..\Test\DotNet\Tests\TestLib\TestLib.inc" -->  <!--_NRE_-->
					<p>Each column in a Grid can have its own editor and datatype. An editor is 
						...
						editors can change data from different data types. For example textboxes and 
