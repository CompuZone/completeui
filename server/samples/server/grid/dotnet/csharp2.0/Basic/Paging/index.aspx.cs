...
namespace GridCSharpSamples.Basic.Paging
{
	/// <summary>
	...
	public partial class index : System.Web.UI.Page
	{
		...
		{
			PagingGrid.DataSources.PrimaryData.DatasourceStructure.Keys.Add("ContactID");
			LocalPagingGrid.DataSourceId = "LocalData";
			LocalPagingGrid.DataBind();
		}
		...
		override protected void OnInit(EventArgs e)
		{
			...
			//
			InitializeComponent();
			//this.PagingGrid.GetData += new Nitobi.Grid.GetEventHandler(this.PagingGrid_GetData);
			//this.PagingGrid.SaveData += new Nitobi.Grid.SaveEventHandler(this.PagingGrid_SaveData);
			base.OnInit(e);
		}
		...
		private void PagingGrid_GetData(object sender, Nitobi.Components.Grid.GetEventArgs e)
		{
			...
			string query="";
			if (PagingGrid.RowsPerPage ==0) PagingGrid.RowsPerPage=20;
		...
		private void PagingGrid_SaveData(object sender, Nitobi.Components.Grid.GridSaveEventArgs e)
		{
			...
			foreach (Row row in PagingGrid.DataSources.PrimaryData.Rows)
			{
			...
			// by the db.
			Rows rs = PagingGrid.DataSources.PrimaryData.Rows;
