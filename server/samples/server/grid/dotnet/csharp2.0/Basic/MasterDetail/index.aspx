...
<%@ Page language="c#" Inherits="GridCSharpSamples.Basic.MasterDetail.index" CodeFile="index.aspx.cs" %>
...
function ChooseCustomer(eventArgs)
{
	...
	<body>
		<!--_NRS_--> <!-- #Include File="..\..\..\..\..\Test\DotNet\Tests\TestLib\TestLib.inc" -->  <!--_NRE_-->
					<p>In a master-detail use case you have at least two grids. One is linked to the 
						other somehow. In this demo, we have a list of customers, and sales for each 
						customer.</p>
					<p><b>***Click on a customer name. Watch the sales update.***</b></p>
						...
						<tr>
							...
							<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px"
								vAlign="top" align="left"><ntb:grid id="DetailGrid" runat="server" Width="250px" Height="250px" Mode="LiveScrolling"
									RowInsertEnabled="False" RowDeleteEnabled="False" ToolbarEnabled="False" DataSources="(Collection)" AutoSpecifyDataHandlerUrls="True">
									<ntb:datasources xmlns:ntb="http://www.nitobi.com">
