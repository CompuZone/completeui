...
public class ShowAllGetHandler extends HttpServlet 
{
		...
		throws ServletException, IOException
	{
		...
		try
		{
			...
			String newQuery = "SELECT * FROM tblcontacts3k LIMIT 0, " + pagesizeParameter + ";";
	...
	private void getRequestParams(HttpServletRequest request)
	{
		...
		{
			pagesizeParameter = "300";  // define default value for parameter pagesize if this page is called without parameter pagesize.
		}
