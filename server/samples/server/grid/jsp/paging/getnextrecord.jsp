...
<%
	...
	*/
	...
	String newQuery = "INSERT INTO tblContacts3k (ContactName) VALUES ('" + randomNumber + "')";

	st.executeUpdate(newQuery);
	
	newQuery = "SELECT ContactID FROM tblContacts3k WHERE ContactName LIKE '" + randomNumber + "';";
	...
	newQuery = "DELETE FROM tblContacts3k WHERE ContactName LIKE '" + randomNumber + "'";
