...
<%
	...
	// We begin by grabbing some of the necessary querystring variables that are generated by the EBA javascript Control
    ...
    We need to create:
    	C:\Program Files\Nitobi\Combo 3.X\Jsp Trial\samples\Basic\Filter\data\customerdb.mdb
