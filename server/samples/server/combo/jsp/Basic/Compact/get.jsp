...
<%
    ...
    We need to create:
    	C:\Program Files\eBusiness Applications\Combo 3.X\Jsp Trial\samples\Basic\Classic\data\customerdb.mdb
	...
	The above breakdown maps to the following:
		...
		getServletPath()  ---> [samples\Basic\Classic] (get.jsp is removed)
    ...
    */
	...
	String newQuery = "SELECT TOP " + pageSize + " * FROM tblCustomers WHERE ContactName LIKE '" + searchSubString + "%' ORDER BY ContactName";	
	...
	{		
		...
		curRecord.setField("ContactImage","resources/scustomerimage.gif");
