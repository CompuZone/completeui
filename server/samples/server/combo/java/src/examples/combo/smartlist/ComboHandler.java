package examples.combo.smartlist;
...
public class ComboHandler extends HttpServlet 
{
		...
		throws ServletException, IOException
	{
		...
		try
		{
			...
			String newQuery = "SELECT ContactID, CONCAT(ContactName, ' <', ContactEmail, '>') AS ContactInfo FROM tblcontacts3k WHERE ContactName LIKE '%" + 
				searchSubString + "%' OR ContactEmail LIKE '%" + searchSubString + "%'  LIMIT " + startParameter + "," + pageSizeParam + ";";
