package examples.combo.classic;
...
public class ComboHandler extends HttpServlet 
{
	...
	/* 
	 * This servlet is used as a Get Handler for the combo. When the combo is initialized,
		...
		throws ServletException, IOException
	{
		...
		try
		{
			...
			// and add the records manually which we begin here with calls to defineField
