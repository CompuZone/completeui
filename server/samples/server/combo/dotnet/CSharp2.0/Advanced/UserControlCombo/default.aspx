<%@ Reference Control="~/advanced/usercontrolcombo/combouc.ascx" %>
<%@ Page language="c#" Inherits="UserControlCombo.WebForm1" validateRequest="false" CodeFile="default.aspx.cs" %>
...
<body>
      ...
      <form id="Form1" method="post" runat="server">
        ...
        <br>
        <br>
        <asp:Button id="btnSubmit" style="Z-INDEX: 101" runat="server" Text="Submit" onclick="btnSubmit_Click"></asp:Button>
        <br>
