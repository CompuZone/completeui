...
#End Region
        ...
        Private Sub Province_GetPage(ByVal sender As Object, ByVal e As Nitobi.ComboGetPageEventArgs) Handles cmbProvince.GetPage
        ...
        Public ReadOnly Property Province() As Nitobi.Combo
            Get
                Province = Me.cmbProvince
            End Get
        End Property

        Public ReadOnly Property Country() As Nitobi.Combo
            Get
                Country = Me.cmbCountry
            End Get
        End Property

        Public ReadOnly Property City() As TextBox
            Get
                City = Me.txtCity
            End Get
        End Property

        Public ReadOnly Property StAddress() As TextBox
            Get
                StAddress = Me.txtStAddress
            End Get
        End Property
