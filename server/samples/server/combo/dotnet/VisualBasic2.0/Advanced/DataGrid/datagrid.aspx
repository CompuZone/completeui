...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="EBAWebComboVisualBasicSamples.DataGrid" CodeFile="DataGrid.aspx.vb" %>
...
<form id="Form1" method="post" runat="server">
      ...
      <P> Note: This sample datagrid does not save the updated information&nbsp;to the 
        database.</P>
      <!-- OnEditCommand="DataGrid1_Edit" OnUpdateCommand="DataGrid1_Update"
      ...
      <asp:datagrid id="DataGrid1" runat="server" Font-Size="10pt" Font-Name="Verdana" HorizontalAlign="Center"
							Width="85%" BackColor="#EEEEEE" Font-Names="Verdana"  AutoGenerateColumns="False">
