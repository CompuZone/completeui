...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Compact.aspx.vb" Inherits="EBAWebComboVisualBasicSamples.Compact" ValidateRequest="false" %>
<HTML>
	<HEAD>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<p>This sample illustrates the use of the Compact Search Mode. In this mode, no 
				dropdown will appear. All the same paging behaviors will occur and you can 
				access all the events as you would in a normal combobox, but the only 
				autocompletion happening is type-ahead.</p>
			...
			<ntb:Combo id="myCombo" style="PADDING-BOTTOM: 1px; PADDING-TOP: 1px" runat="server" PreconfiguredStylesheet="WinOfficeXP"
				Mode="Compact" StylesheetURL="nitobi.combo.css">
