...
#End Region
    ...
    Private Function GetPage(ByVal PageSize As Integer, ByVal SubString As String, ByVal CurrentRecord As Integer, ByVal LastString As String) As DataSet
        ...
        dbAdapter = New OleDbDataAdapter("SELECT TOP " & PageSize & " * FROM noun WHERE singular > '" & LastString & "' AND singular LIKE '" & SubString & "%' ORDER BY singular", dbConn)
        dbAdapter.Fill(ds, "noun")
