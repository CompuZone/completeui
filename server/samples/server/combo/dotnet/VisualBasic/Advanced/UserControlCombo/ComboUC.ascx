<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ComboUC.ascx.vb" Inherits="EBAWebComboVisualBasicSamples.ComboUC" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<%
	...
	if( not me.Page.IsClientScriptBlockRegistered( "ComboUCJSCode" ) )  
		...
		script = script & "	var provinceCombo = document.getElementById(idPrefix+':Province').object;" 
		script = script & "	" 
