<%@ Page language="c#" Codebehind="Classic.aspx.cs" AutoEventWireup="false" Inherits="Paging.Paging" ValidateRequest="false"%>
...
<form id="Form1" method="post" runat="server">
  ...
  <p><strong>One Additional Note</strong>: In this demo, we can submit the form 
    ...
    appear at the bottom of the page. </p>
...
PostBackOnSelectEvent="True" HttpRequestMethod="Get">
