...
<%
	...
	dim FileandFolder
	FileandFolder = "\data\NorthWindUltra.mdb"	
	...
	EBAGetHandler_DefineField("ContactTitle") 'column index 3
	...
	if MaxRecords > StartRecordIndex then
		do while not RecordSet.eof
			...
			EBAGetHandler_CreateNewRecord(RecordSet("CustomerID"))
				EBAGetHandler_DefineRecordFieldValue "CustomerID", RecordSet("CustomerID")
				EBAGetHandler_DefineRecordFieldValue "ContactName", RecordSet("CustomerName")
