...
<cfquery name="CustomerQuery" datasource="NitobiTestDB">
      ...
      SELECT TOP #TotalRecordsToRetrieve# * FROM tblMDOrders WHERE CustomerID='#CustomerID#' ORDER BY #SortColumn# #SortDirection#

</cfquery>
<cfoutput>
#EBAGetHandler_SetTotalRowCount(50)#
</cfoutput>
...
<cfoutput query="CustomerQuery">
	...
	<cfif CurrentRecord GREATER THAN StartRecordIndex >
		#EBAGetHandler_CreateNewRecord(OrderID)#
			#EBAGetHandler_DefineRecordFieldValue("OrderID", OrderID)#
