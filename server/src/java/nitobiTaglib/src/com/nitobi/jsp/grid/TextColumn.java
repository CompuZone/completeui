...
/**
 * @author mhan
 * @jsp.tag name="textcolumn"
 * description="A tag to output a ntb:textcolumn element"
 *
 */
public class TextColumn extends NitobiBodyTag 
{
	private static final long serialVersionUID = -4099652783278370102L;
	...
	private void writeTextColumnStartTag() throws JspException
	{
		try
		{
			pageContext.getOut().print("<ntb:textcolumn ");
			writeTagAttributes();
