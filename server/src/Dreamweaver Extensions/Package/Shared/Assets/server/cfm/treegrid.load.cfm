...
<cfset WhereClause = "/*** NTB_WHERECLAUSE ***/">
...
<cfquery name="/*** NTB_TABLE ***/" datasource="/*** NTB_DATASOURCE ***/">
      /*** NTB_QUERY ***/
</cfquery>

<cfquery name="count" datasource="/*** NTB_DATASOURCE ***/">
	SELECT COUNT(*) AS count FROM /*** NTB_TABLE ***/ #PreserveSingleQuotes(WhereClause)#
</cfquery>
<cfoutput query="count">
#EBAGetHandler_SetTotalRowCount(count)#
</cfoutput>
...
<cfoutput query="/*** NTB_TABLE ***/" startrow="#CurrentRecord#">
