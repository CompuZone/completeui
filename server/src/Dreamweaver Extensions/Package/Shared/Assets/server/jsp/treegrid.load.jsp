...
<%
	...
	String whereClause = "/*** NTB_WHERECLAUSE ***/";
	String newQuery = /*** NTB_QUERY ***/;
	ResultSet rs = st.executeQuery(newQuery);
	
	Statement countStatement = con.createStatement();
	ResultSet countRs = countStatement.executeQuery("SELECT COUNT(*) AS totalRowCount FROM " + tableName + " " + whereClause);
	countRs.next();
	int totalRowCount = countRs.getInt("totalRowCount");
	...
	myGetHandler.setTotalRowCount(totalRowCount);
