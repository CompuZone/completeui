...
<%
	...
	DefaultOrderByColumn = "/*** NTB_SORTCOLUMN ***/"
	...
	' the gethandler.  We'll use these fields to get the data bound to that row.
	/*** NTB_FKEY_QSTRING ***/
	
	dim WhereClause
	WhereClause = "/*** NTB_WHERECLAUSE ***/"
	...
	countRecordSet = objConn.execute("SELECT COUNT(*) FROM /*** NTB_TABLE ***/ " & WhereClause)
	dim MaxRecords
	dim totalRowCount
