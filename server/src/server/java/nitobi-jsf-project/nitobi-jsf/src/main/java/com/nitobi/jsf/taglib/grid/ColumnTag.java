...
import com.nitobi.jsf.component.grid.UIColumn;
...
public class ColumnTag extends UIComponentELTag {
    ...
    public static final String X_DATA_FIELD_ATTNAME = "xmlDataField";
    ...
    public String getRendererType() {
        return UIColumn.DEFAULT_RENDERER_TYPE;
    }
    ...
    protected void setProperties(UIComponent component) {
        ...
        component.setValueExpression(X_DATA_FIELD_ATTNAME, xmlDataField);
