...
/**
 * @author mhan
 * @jsp.tag name="numbercolumn"
 * description="A tag to output a ntb:numbercolumn element"
 *
 */
public class NumberColumn extends NitobiBodyTag 
{
	private static final long serialVersionUID = 8095883665639104327L;
	private String mask;
	...
	private void writeTextColumnStartTag() throws JspException
	{
		try
		{
			pageContext.getOut().print("<ntb:numbercolumn ");
			writeTagAttributes();
	 ...
	 * @jsp.attribute required="false" 
	 * 				  rtexprvalue="true" 
	 * 				  description="The decimalseparator attribute" 
	 ...
	 * @jsp.attribute required="false" 
	 * 				  rtexprvalue="true" 
	 * 				  description="The groupingseparator attribute" 
	 ...
	 * @jsp.attribute required="false" 
	 * 				  rtexprvalue="true" 
	 * 				  description="The negativemask attribute" 
	 * @return the negativemask
	 */
	public String getNegativemask() {
		return negativemask;
	}

	/**
	 * @param negativemask the negativemask to set
	 */
	public void setNegativemask(String negativemask) {
