 ...
 * @author mhan
 * @jsp.tag name="grid"
 * description="The Nitobi Grid component.
 ...
 *
 */
public class Grid extends NitobiComponentTag 
{
	private static final long serialVersionUID = -2257842284946987060L;
	private String id;
	...
	private String componentjsurl = Globals.SCRIPTPATH + "nitobi.grid.js";
	private String componentcssurl = Globals.STYLEPATH + "nitobi.grid.css";
	
	public int doStartTag() throws JspException
	{
		if (getIncluderesources() == "true")
		{
			writeScriptTags("grid");
			writeStyleTag("grid");
		}
	...
	private void writeGridStartTag() throws JspException
	{
		try
		{
			pageContext.getOut().println("<?XML:NAMESPACE prefix=\"ntb\" />");
			pageContext.getOut().print("<ntb:grid ");
			writeTagAttributes();
	...
	private void writeGridEndTag() throws JspException
	{
		try
		{
			pageContext.getOut().print("</ntb:grid>");
