...
nitobi.fisheye.build="7054";
nitobi.fisheye.version="1.0.7054";
nitobi.lang.defineNs("nitobi.fisheye");
if(false){
...
function handleMouse(_2f){
var sP=nitobi.html.getScroll();
var _31=false;
var _32,_33;
var _34=false;
var _35=0;
_32=_2f.clientX+sP.left;
_33=_2f.clientY+sP.top;
var t,f,w,h,x,y,o,ol,p,q,_40,_41;
var _42=fisheyeList.length;
for(t=0;t<_42;t++){
o=fisheyeList[t];
if(o.loaded){
w=o.iconWidth;
...
if(o.eD==0){
p=Math.abs(x-_32+o.iconWidth/2+(o.currentxoffset*(f/ol)));
}
if(o.eD==1){
p=Math.abs(x-_32-(o.iconWidth/2)-(o.currentxoffset*((ol-f)/ol)));
}
q=Math.abs(y-_33);
_40=p;
if(q>o.yBoundary){
...
o.mouseY=_33;
o.foundActive=true;
_41=1-(_40/(w*o.rangeSensitivity));
_43.mysize=_41;
if(o.highval<_41){
o.highval=_41;
o.highindex=f;
...
nitobi.lang.defineNs("nitobi.fisheye");
nitobi.fisheye.MenuItem=function(_44){
nitobi.fisheye.MenuItem.baseConstructor.call(this,_44);
...
nitobi.fisheye.MenuItem.prototype.setImageSource=function(_45){
this.setAttribute("imagesrc",_45);
this.src=_45;
};
nitobi.fisheye.MenuItem.prototype.setLabel=function(_46){
this.setAttribute("label",_46);
this.imgLabel=_46;
};
