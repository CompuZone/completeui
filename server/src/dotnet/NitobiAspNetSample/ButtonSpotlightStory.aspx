<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ButtonSpotlightStory.aspx.cs" Inherits="test.ButtonSpotlightStory" MasterPageFile="Site1.Master"  %>
<%@ Register Assembly="NitobiControls" Namespace="Nitobi" TagPrefix="ntb" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="main">
	<ntb:ButtonSpotlight runat="server" ID="spt" Theme="Clean" ImageUrl="images/spotlight.png">
