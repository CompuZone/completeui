<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComboWithIndentedText.aspx.cs" Inherits="test.IndentedCombo" MasterPageFile="Site1.Master"  %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="main">
    ...
    <table><tr><td width="300px" valign="top">
		...
		<ntb:Combo ID="c" runat="server" DataTextField="ProductName" AutoPostBack="true" Mode="Classic" GetDataUrl="DataHandler.ashx"  DataSourceId="indentedProductNames">
			<TextBox Width="250" />
